...
# All files are located in /captcha_solver.
...
RUN mkdir /captcha_solver
WORKDIR /captcha_solver
#ADD pocketsphinx /captcha_solver/pocketsphinx
ADD captcha_solver.yaml /captcha_solver
# ADD proxies.txt /captcha_solver/proxies.txt
...
EXPOSE 5000
CMD ["python3.6", "/captcha_solver/examples/app.py"]